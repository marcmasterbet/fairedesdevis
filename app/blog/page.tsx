...
const villes = [
  ...
  { nom: 'Saint-Etienne', region: 'Auvergne-Rhône-Alpes' },
  ...
  { nom: 'Nimes', region: 'Occitanie' },
  { nom: 'Villeurbanne', region: 'Auvergne-Rhône-Alpes' },
  { nom: 'Clermont-Ferrand', region: 'Auvergne-Rhône-Alpes' },
  { nom: 'Aix-en-Provence', region: 'Provence-Alpes-Côte d\'Azur' },
  { nom: 'Brest', region: 'Bretagne' },
  { nom: 'Tours', region: 'Centre-Val de Loire' },
  { nom: 'Amiens', region: 'Hauts-de-France' },
  { nom: 'Limoges', region: 'Nouvelle-Aquitaine' },
  { nom: 'Annecy', region: 'Auvergne-Rhône-Alpes' },
  { nom: 'Perpignan', region: 'Occitanie' },
  { nom: 'Boulogne-Billancourt', region: 'Île-de-France' },
  { nom: 'Metz', region: 'Grand Est' },
  { nom: 'Besancon', region: 'Bourgogne-Franche-Comté' },
  { nom: 'Orléans', region: 'Centre-Val de Loire' },
  { nom: 'Rouen', region: 'Normandie' },
  { nom: 'Mulhouse', region: 'Grand Est' },
  { nom: 'Caen', region: 'Normandie' },
  { nom: 'Nancy', region: 'Grand Est' },
  { nom: 'Saint-Denis', region: 'Île-de-France' },
  { nom: 'Argenteuil', region: 'Île-de-France' },
  { nom: 'Montreuil', region: 'Île-de-France' },
  { nom: 'Roubaix', region: 'Hauts-de-France' },
  { nom: 'Tourcoing', region: 'Hauts-de-France' },
  { nom: 'Avignon', region: 'Provence-Alpes-Côte d\'Azur' },
  { nom: 'Dunkerque', region: 'Hauts-de-France' },
  { nom: 'Poitiers', region: 'Nouvelle-Aquitaine' },
  { nom: 'Versailles', region: 'Île-de-France' },
  { nom: 'Colombes', region: 'Île-de-France' },
  { nom: 'Pau', region: 'Nouvelle-Aquitaine' },
  { nom: 'Vitry-sur-Seine', region: 'Île-de-France' },
  { nom: 'La Rochelle', region: 'Nouvelle-Aquitaine' },
  { nom: 'Cannes', region: 'Provence-Alpes-Côte d\'Azur' },
  { nom: 'Colmar', region: 'Grand Est' },
]
