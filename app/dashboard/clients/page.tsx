          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Nom / Societe</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.nom} onChange={e => setEdit('nom', e.target.value)} /> : <p className="text-sm font-medium text-gray-900">{c.nom}</p>}
                </div>
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Email</label>
                  {editing ? <input type="email" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.email} onChange={e => setEdit('email', e.target.value)} /> : <p className="text-sm text-gray-700">{c.email}</p>}
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Telephone mobile</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.telephone || ''} onChange={e => setEdit('telephone', e.target.value)} placeholder="06 12 34 56 78" /> : <p className="text-sm text-gray-700">{c.telephone || '—'}</p>}
                </div>
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Telephone fixe</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.telephone_fixe || ''} onChange={e => setEdit('telephone_fixe', e.target.value)} placeholder="03 88 12 34 56" /> : <p className="text-sm text-gray-700">{c.telephone_fixe || '—'}</p>}
                </div>
              </div>
              <div>
                <label className="text-xs text-gray-500 mb-1 block">Adresse</label>
                {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.adresse || ''} onChange={e => setEdit('adresse', e.target.value)} /> : <p className="text-sm text-gray-700">{c.adresse || '—'}</p>}
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Code postal</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.code_postal || ''} onChange={e => setEdit('code_postal', e.target.value)} /> : <p className="text-sm text-gray-700">{c.code_postal || '—'}</p>}
                </div>
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Ville</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.ville || ''} onChange={e => setEdit('ville', e.target.value)} /> : <p className="text-sm text-gray-700">{c.ville || '—'}</p>}
                </div>
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Pays</label>
                  {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.pays || ''} onChange={e => setEdit('pays', e.target.value)} /> : <p className="text-sm text-gray-700">{c.pays || '—'}</p>}
                </div>
              </div>
              <div>
                <label className="text-xs text-gray-500 mb-1 block">SIRET</label>
                {editing ? <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" value={c.siret || ''} onChange={e => setEdit('siret', e.target.value)} placeholder="123 456 789 00012" /> : <p className="text-sm text-gray-700">{c.siret || '—'}</p>}
              </div>
            </div>
          </div>
            ...
            {filtered.map(client => (
              ...
              >
                ...
                <div className="flex gap-2 flex-shrink-0" onClick={e => e.stopPropagation()}>
                  <button onClick={() => { setSelectedClient(client); setEditingClient(client) }} className="text-xs bg-gray-100 text-gray-600 px-3 py-1 rounded-lg hover:bg-gray-200">
                    Modifier
                  </button>
