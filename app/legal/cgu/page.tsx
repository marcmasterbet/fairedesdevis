      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-gray-600">
          ...
          <section>
            ...
            <p>Le service propose une période d'essai gratuite de 7 jours. Une carte bancaire est requise à l'inscription afin de garantir la continuité du service — aucun prélèvement n'est effectué pendant cette période. L'utilisateur peut annuler à tout moment avant la fin de l'essai sans aucun frais.</p>
            <p className="mt-2">À l'issue de la période d'essai, l'accès au service est conditionné à la souscription d'un abonnement mensuel au tarif en vigueur (24,99€ TTC/mois). L'abonnement est sans engagement et résiliable à tout moment en 1 clic.</p>
          </section>
